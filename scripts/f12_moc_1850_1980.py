...
@author: Shihan Li
plot the velocity of ocean current in Atlantic and Pacific
"""
...
ax1.clabel(cont1, cont1.levels,fmt = '%.0f', colors = 'black')
...
ax2.clabel(cont2, cont2.levels,fmt = '%.0f', colors = 'black')
